#[doc = "Reader of register GPTMTBPR"]
pub type R = crate::R<u32, super::GPTMTBPR>;
#[doc = "Writer for register GPTMTBPR"]
pub type W = crate::W<u32, super::GPTMTBPR>;
#[doc = "Register GPTMTBPR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPTMTBPR {
    type Type = u32;
    #[inline(always)]
