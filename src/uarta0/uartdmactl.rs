#[doc = "Reader of register UARTDMACTL"]
pub type R = crate::R<u32, super::UARTDMACTL>;
#[doc = "Writer for register UARTDMACTL"]
pub type W = crate::W<u32, super::UARTDMACTL>;
#[doc = "Register UARTDMACTL `reset()`'s with value 0"]
impl crate::ResetValue for super::UARTDMACTL {
    type Type = u32;
    #[inline(always)]
