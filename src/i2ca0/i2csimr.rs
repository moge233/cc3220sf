#[doc = "Reader of register I2CSIMR"]
pub type R = crate::R<u32, super::I2CSIMR>;
#[doc = "Writer for register I2CSIMR"]
pub type W = crate::W<u32, super::I2CSIMR>;
#[doc = "Register I2CSIMR `reset()`'s with value 0"]
impl crate::ResetValue for super::I2CSIMR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 1 - Data interrupt mask"]
    #[inline(always)]
    pub fn dataim(&self) -> DATAIM_R {
        DATAIM_R::new(((self.bits >> 1) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 8 - Receive FIFO full interrupt mask"]
