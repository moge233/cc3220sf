#[doc = "Reader of register I2CSACKCTL"]
pub type R = crate::R<u32, super::I2CSACKCTL>;
#[doc = "Writer for register I2CSACKCTL"]
pub type W = crate::W<u32, super::I2CSACKCTL>;
#[doc = "Register I2CSACKCTL `reset()`'s with value 0"]
impl crate::ResetValue for super::I2CSACKCTL {
    type Type = u32;
    #[inline(always)]
