#[doc = "Reader of register OBSMUXSEL0"]
pub type R = crate::R<u32, super::OBSMUXSEL0>;
#[doc = "Writer for register OBSMUXSEL0"]
pub type W = crate::W<u32, super::OBSMUXSEL0>;
#[doc = "Register OBSMUXSEL0 `reset()`'s with value 0"]
impl crate::ResetValue for super::OBSMUXSEL0 {
    type Type = u32;
    #[inline(always)]
