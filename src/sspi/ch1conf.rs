#[doc = "Reader of register CH1CONF"]
pub type R = crate::R<u32, super::CH1CONF>;
#[doc = "Writer for register CH1CONF"]
pub type W = crate::W<u32, super::CH1CONF>;
#[doc = "Register CH1CONF `reset()`'s with value 0"]
impl crate::ResetValue for super::CH1CONF {
    type Type = u32;
    #[inline(always)]
...
pub type TCS1_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TCS1`"]
pub struct TCS1_W<'a> {
    w: &'a mut W,
}
impl<'a> TCS1_W<'a> {
