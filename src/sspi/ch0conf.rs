#[doc = "Reader of register CH0CONF"]
pub type R = crate::R<u32, super::CH0CONF>;
#[doc = "Writer for register CH0CONF"]
pub type W = crate::W<u32, super::CH0CONF>;
#[doc = "Register CH0CONF `reset()`'s with value 0"]
impl crate::ResetValue for super::CH0CONF {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `TCS0`"]
pub type TCS0_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TCS0`"]
pub struct TCS0_W<'a> {
    w: &'a mut W,
}
impl<'a> TCS0_W<'a> {
...
#[doc = "Reader of field `SPIENSLV`"]
pub type SPIENSLV_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `SPIENSLV`"]
pub struct SPIENSLV_W<'a> {
    w: &'a mut W,
}
impl<'a> SPIENSLV_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
impl R {
    ...
    #[inline(always)]
    pub fn tcs0(&self) -> TCS0_R {
        TCS0_R::new(((self.bits >> 25) & 0x03) as u8)
    }
    #[doc = "Bits 21:22 - Channel 0 only and slave mode only: SPI slave select signal detection. Reserved bits for other cases. 0x0 Detection enabled only on SPIEN\\[0\\]
0x1 Detection enabled only on SPIEN\\[1\\]
0x2 Detection enabled only on SPIEN\\[2\\]
0x3 Detection enabled only on SPIEN\\[3\\]"]
    #[inline(always)]
    pub fn spienslv(&self) -> SPIENSLV_R {
        SPIENSLV_R::new(((self.bits >> 21) & 0x03) as u8)
    }
...
0x3 Detection enabled only on SPIEN\\[3\\]"]
    #[inline(always)]
    pub fn spienslv(&mut self) -> SPIENSLV_W {
        SPIENSLV_W { w: self }
    }
    #[doc = "Bits 12:13 - Transmit/Receive modes 0x0 Transmit and Receive mode 0x1 Receive only mode 0x2 Transmit only mode 0x3 Reserved"]
    #[inline(always)]
