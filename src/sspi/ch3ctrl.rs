#[doc = "Reader of register CH3CTRL"]
pub type R = crate::R<u32, super::CH3CTRL>;
#[doc = "Writer for register CH3CTRL"]
pub type W = crate::W<u32, super::CH3CTRL>;
#[doc = "Register CH3CTRL `reset()`'s with value 0"]
impl crate::ResetValue for super::CH3CTRL {
    type Type = u32;
    #[inline(always)]
