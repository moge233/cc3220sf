#[doc = "Reader of register CHANNEL6FIFODATA"]
pub type R = crate::R<u32, super::CHANNEL6FIFODATA>;
#[doc = "Writer for register CHANNEL6FIFODATA"]
pub type W = crate::W<u32, super::CHANNEL6FIFODATA>;
#[doc = "Register CHANNEL6FIFODATA `reset()`'s with value 0"]
impl crate::ResetValue for super::CHANNEL6FIFODATA {
    type Type = u32;
    #[inline(always)]
