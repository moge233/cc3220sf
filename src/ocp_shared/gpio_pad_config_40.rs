#[doc = "Reader of register GPIO_PAD_CONFIG_40"]
pub type R = crate::R<u32, super::GPIO_PAD_CONFIG_40>;
#[doc = "Writer for register GPIO_PAD_CONFIG_40"]
pub type W = crate::W<u32, super::GPIO_PAD_CONFIG_40>;
#[doc = "Register GPIO_PAD_CONFIG_40 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_PAD_CONFIG_40 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `MEM_GPIO_PAD_CONFIG_40`"]
pub type MEM_GPIO_PAD_CONFIG_40_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `MEM_GPIO_PAD_CONFIG_40`"]
pub struct MEM_GPIO_PAD_CONFIG_40_W<'a> {
    w: &'a mut W,
}
impl<'a> MEM_GPIO_PAD_CONFIG_40_W<'a> {
