#[doc = "Reader of register WLAN_SRAM_ACTIVE_PWR_CFG"]
pub type R = crate::R<u32, super::WLAN_SRAM_ACTIVE_PWR_CFG>;
#[doc = "Writer for register WLAN_SRAM_ACTIVE_PWR_CFG"]
pub type W = crate::W<u32, super::WLAN_SRAM_ACTIVE_PWR_CFG>;
#[doc = "Register WLAN_SRAM_ACTIVE_PWR_CFG `reset()`'s with value 0"]
impl crate::ResetValue for super::WLAN_SRAM_ACTIVE_PWR_CFG {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `WLAN_SRAM_ACTIVE_PWR_CFG`"]
pub type WLAN_SRAM_ACTIVE_PWR_CFG_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `WLAN_SRAM_ACTIVE_PWR_CFG`"]
pub struct WLAN_SRAM_ACTIVE_PWR_CFG_W<'a> {
    w: &'a mut W,
}
impl<'a> WLAN_SRAM_ACTIVE_PWR_CFG_W<'a> {
...
impl R {
    #[doc = "Bits 0:23 - SRAM (WTOP+DRP) state during Active-mode : 1 - SRAMs are ON ; 0 - SRAMs are OFF. Cluster information : \\[0\\]
...
- Internal to WTOP Cluster"]
    #[inline(always)]
    pub fn wlan_sram_active_pwr_cfg(&self) -> WLAN_SRAM_ACTIVE_PWR_CFG_R {
        WLAN_SRAM_ACTIVE_PWR_CFG_R::new((self.bits & 0x00ff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:23 - SRAM (WTOP+DRP) state during Active-mode : 1 - SRAMs are ON ; 0 - SRAMs are OFF. Cluster information : \\[0\\]
...
- Internal to WTOP Cluster"]
    #[inline(always)]
    pub fn wlan_sram_active_pwr_cfg(&mut self) -> WLAN_SRAM_ACTIVE_PWR_CFG_W {
        WLAN_SRAM_ACTIVE_PWR_CFG_W { w: self }
    }
}
