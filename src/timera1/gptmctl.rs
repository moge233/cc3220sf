#[doc = "Reader of register GPTMCTL"]
pub type R = crate::R<u32, super::GPTMCTL>;
#[doc = "Writer for register GPTMCTL"]
pub type W = crate::W<u32, super::GPTMCTL>;
#[doc = "Register GPTMCTL `reset()`'s with value 0"]
impl crate::ResetValue for super::GPTMCTL {
    type Type = u32;
    #[inline(always)]
