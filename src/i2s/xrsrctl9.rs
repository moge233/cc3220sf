#[doc = "Reader of register XRSRCTL9"]
pub type R = crate::R<u32, super::XRSRCTL9>;
#[doc = "Writer for register XRSRCTL9"]
pub type W = crate::W<u32, super::XRSRCTL9>;
#[doc = "Register XRSRCTL9 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL9 {
    type Type = u32;
    #[inline(always)]
