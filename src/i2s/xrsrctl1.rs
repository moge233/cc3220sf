#[doc = "Reader of register XRSRCTL1"]
pub type R = crate::R<u32, super::XRSRCTL1>;
#[doc = "Writer for register XRSRCTL1"]
pub type W = crate::W<u32, super::XRSRCTL1>;
#[doc = "Register XRSRCTL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL1 {
    type Type = u32;
    #[inline(always)]
