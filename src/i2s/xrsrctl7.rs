#[doc = "Reader of register XRSRCTL7"]
pub type R = crate::R<u32, super::XRSRCTL7>;
#[doc = "Writer for register XRSRCTL7"]
pub type W = crate::W<u32, super::XRSRCTL7>;
#[doc = "Register XRSRCTL7 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL7 {
    type Type = u32;
    #[inline(always)]
