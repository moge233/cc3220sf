#[doc = "Reader of register XRSRCTL11"]
pub type R = crate::R<u32, super::XRSRCTL11>;
#[doc = "Writer for register XRSRCTL11"]
pub type W = crate::W<u32, super::XRSRCTL11>;
#[doc = "Register XRSRCTL11 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL11 {
    type Type = u32;
    #[inline(always)]
