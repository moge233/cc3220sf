#[doc = "Reader of register XRSRCTL6"]
pub type R = crate::R<u32, super::XRSRCTL6>;
#[doc = "Writer for register XRSRCTL6"]
pub type W = crate::W<u32, super::XRSRCTL6>;
#[doc = "Register XRSRCTL6 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL6 {
    type Type = u32;
    #[inline(always)]
