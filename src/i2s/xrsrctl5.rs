#[doc = "Reader of register XRSRCTL5"]
pub type R = crate::R<u32, super::XRSRCTL5>;
#[doc = "Writer for register XRSRCTL5"]
pub type W = crate::W<u32, super::XRSRCTL5>;
#[doc = "Register XRSRCTL5 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL5 {
    type Type = u32;
    #[inline(always)]
