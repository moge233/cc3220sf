#[doc = "Reader of register XRSRCTL4"]
pub type R = crate::R<u32, super::XRSRCTL4>;
#[doc = "Writer for register XRSRCTL4"]
pub type W = crate::W<u32, super::XRSRCTL4>;
#[doc = "Register XRSRCTL4 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL4 {
    type Type = u32;
    #[inline(always)]
