#[doc = "Reader of register XRSRCTL3"]
pub type R = crate::R<u32, super::XRSRCTL3>;
#[doc = "Writer for register XRSRCTL3"]
pub type W = crate::W<u32, super::XRSRCTL3>;
#[doc = "Register XRSRCTL3 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL3 {
    type Type = u32;
    #[inline(always)]
