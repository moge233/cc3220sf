#[doc = "Reader of register XRSRCTL10"]
pub type R = crate::R<u32, super::XRSRCTL10>;
#[doc = "Writer for register XRSRCTL10"]
pub type W = crate::W<u32, super::XRSRCTL10>;
#[doc = "Register XRSRCTL10 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL10 {
    type Type = u32;
    #[inline(always)]
