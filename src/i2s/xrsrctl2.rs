#[doc = "Reader of register XRSRCTL2"]
pub type R = crate::R<u32, super::XRSRCTL2>;
#[doc = "Writer for register XRSRCTL2"]
pub type W = crate::W<u32, super::XRSRCTL2>;
#[doc = "Register XRSRCTL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL2 {
    type Type = u32;
    #[inline(always)]
