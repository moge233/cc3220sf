#[doc = "Reader of register XRSRCTL13"]
pub type R = crate::R<u32, super::XRSRCTL13>;
#[doc = "Writer for register XRSRCTL13"]
pub type W = crate::W<u32, super::XRSRCTL13>;
#[doc = "Register XRSRCTL13 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL13 {
    type Type = u32;
    #[inline(always)]
