#[doc = "Reader of register XRSRCTL12"]
pub type R = crate::R<u32, super::XRSRCTL12>;
#[doc = "Writer for register XRSRCTL12"]
pub type W = crate::W<u32, super::XRSRCTL12>;
#[doc = "Register XRSRCTL12 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL12 {
    type Type = u32;
    #[inline(always)]
