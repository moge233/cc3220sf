#[doc = "Reader of register XRSRCTL8"]
pub type R = crate::R<u32, super::XRSRCTL8>;
#[doc = "Writer for register XRSRCTL8"]
pub type W = crate::W<u32, super::XRSRCTL8>;
#[doc = "Register XRSRCTL8 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL8 {
    type Type = u32;
    #[inline(always)]
