#[doc = "Reader of register XRSRCTL14"]
pub type R = crate::R<u32, super::XRSRCTL14>;
#[doc = "Writer for register XRSRCTL14"]
pub type W = crate::W<u32, super::XRSRCTL14>;
#[doc = "Register XRSRCTL14 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL14 {
    type Type = u32;
    #[inline(always)]
