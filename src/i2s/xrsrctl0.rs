#[doc = "Reader of register XRSRCTL0"]
pub type R = crate::R<u32, super::XRSRCTL0>;
#[doc = "Writer for register XRSRCTL0"]
pub type W = crate::W<u32, super::XRSRCTL0>;
#[doc = "Register XRSRCTL0 `reset()`'s with value 0"]
impl crate::ResetValue for super::XRSRCTL0 {
    type Type = u32;
    #[inline(always)]
