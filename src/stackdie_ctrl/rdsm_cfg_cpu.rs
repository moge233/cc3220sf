#[doc = "Reader of register RDSM_CFG_CPU"]
pub type R = crate::R<u32, super::RDSM_CFG_CPU>;
#[doc = "Writer for register RDSM_CFG_CPU"]
pub type W = crate::W<u32, super::RDSM_CFG_CPU>;
#[doc = "Register RDSM_CFG_CPU `reset()`'s with value 0"]
impl crate::ResetValue for super::RDSM_CFG_CPU {
    type Type = u32;
    #[inline(always)]
