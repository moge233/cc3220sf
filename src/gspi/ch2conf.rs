#[doc = "Reader of register CH2CONF"]
pub type R = crate::R<u32, super::CH2CONF>;
#[doc = "Writer for register CH2CONF"]
pub type W = crate::W<u32, super::CH2CONF>;
#[doc = "Register CH2CONF `reset()`'s with value 0"]
impl crate::ResetValue for super::CH2CONF {
    type Type = u32;
    #[inline(always)]
...
pub type TCS2_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TCS2`"]
pub struct TCS2_W<'a> {
    w: &'a mut W,
}
impl<'a> TCS2_W<'a> {
...
impl R {
    ...
    pub fn tcs2(&self) -> TCS2_R {
        TCS2_R::new(((self.bits >> 25) & 0x03) as u8)
    }
