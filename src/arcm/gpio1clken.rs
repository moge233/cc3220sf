#[doc = "Reader of register GPIO1CLKEN"]
pub type R = crate::R<u32, super::GPIO1CLKEN>;
#[doc = "Writer for register GPIO1CLKEN"]
pub type W = crate::W<u32, super::GPIO1CLKEN>;
#[doc = "Register GPIO1CLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO1CLKEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 16 - GPIO_B_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - GPIO_B_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - GPIO_B_RUN_CLK_ENABLE"]
    #[inline(always)]
