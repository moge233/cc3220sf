#[doc = "Reader of register GPIO2CLKEN"]
pub type R = crate::R<u32, super::GPIO2CLKEN>;
#[doc = "Writer for register GPIO2CLKEN"]
pub type W = crate::W<u32, super::GPIO2CLKEN>;
#[doc = "Register GPIO2CLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO2CLKEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 16 - GPIO_C_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - GPIO_C_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - GPIO_C_RUN_CLK_ENABLE"]
    #[inline(always)]
