#[doc = "Reader of register CAMCLKEN"]
pub type R = crate::R<u32, super::CAMCLKEN>;
#[doc = "Writer for register CAMCLKEN"]
pub type W = crate::W<u32, super::CAMCLKEN>;
#[doc = "Register CAMCLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::CAMCLKEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 16 - CAMERA_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - CAMERA_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - CAMERA_RUN_CLK_ENABLE"]
    #[inline(always)]
