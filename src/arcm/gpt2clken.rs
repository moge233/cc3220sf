#[doc = "Reader of register GPT2CLKEN"]
pub type R = crate::R<u32, super::GPT2CLKEN>;
#[doc = "Writer for register GPT2CLKEN"]
pub type W = crate::W<u32, super::GPT2CLKEN>;
#[doc = "Register GPT2CLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::GPT2CLKEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 16 - GPT_A2_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - GPT_A2_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - GPT_A2_RUN_CLK_ENABLE"]
    #[inline(always)]
