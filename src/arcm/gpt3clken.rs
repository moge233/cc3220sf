#[doc = "Reader of register GPT3CLKEN"]
pub type R = crate::R<u32, super::GPT3CLKEN>;
#[doc = "Writer for register GPT3CLKEN"]
pub type W = crate::W<u32, super::GPT3CLKEN>;
#[doc = "Register GPT3CLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::GPT3CLKEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 16 - GPT_A3_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - GPT_A3_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - GPT_A3_RUN_CLK_ENABLE"]
    #[inline(always)]
