#[doc = "Reader of register MCASPCLKEN"]
pub type R = crate::R<u32, super::MCASPCLKEN>;
#[doc = "Writer for register MCASPCLKEN"]
pub type W = crate::W<u32, super::MCASPCLKEN>;
#[doc = "Register MCASPCLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::MCASPCLKEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 16 - MCASP_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - MCASP_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - MCASP_RUN_CLK_ENABLE"]
    #[inline(always)]
