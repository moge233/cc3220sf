#[doc = "Reader of register GPIO4CLKEN"]
pub type R = crate::R<u32, super::GPIO4CLKEN>;
#[doc = "Writer for register GPIO4CLKEN"]
pub type W = crate::W<u32, super::GPIO4CLKEN>;
#[doc = "Register GPIO4CLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO4CLKEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 16 - GPIO_E_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - GPIO_E_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - GPIO_E_RUN_CLK_ENABLE"]
    #[inline(always)]
