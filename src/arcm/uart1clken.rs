#[doc = "Reader of register UART1CLKEN"]
pub type R = crate::R<u32, super::UART1CLKEN>;
#[doc = "Writer for register UART1CLKEN"]
pub type W = crate::W<u32, super::UART1CLKEN>;
#[doc = "Register UART1CLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::UART1CLKEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 16 - UART_A1_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - UART_A1_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - UART_A1_RUN_CLK_ENABLE"]
    #[inline(always)]
