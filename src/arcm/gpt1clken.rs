#[doc = "Reader of register GPT1CLKEN"]
pub type R = crate::R<u32, super::GPT1CLKEN>;
#[doc = "Writer for register GPT1CLKEN"]
pub type W = crate::W<u32, super::GPT1CLKEN>;
#[doc = "Register GPT1CLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::GPT1CLKEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 16 - GPT_A1_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - GPT_A1_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - GPT_A1_RUN_CLK_ENABLE"]
    #[inline(always)]
