#[doc = "Reader of register DMACLKEN"]
pub type R = crate::R<u32, super::DMACLKEN>;
#[doc = "Writer for register DMACLKEN"]
pub type W = crate::W<u32, super::DMACLKEN>;
#[doc = "Register DMACLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::DMACLKEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 16 - UDMA_A_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - UDMA_A_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - UDMA_A_RUN_CLK_ENABLE"]
    #[inline(always)]
