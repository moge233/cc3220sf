#[doc = "Reader of register SDIOMCLKEN"]
pub type R = crate::R<u32, super::SDIOMCLKEN>;
#[doc = "Writer for register SDIOMCLKEN"]
pub type W = crate::W<u32, super::SDIOMCLKEN>;
#[doc = "Register SDIOMCLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::SDIOMCLKEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 16 - MMCHS_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - MMCHS_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - MMCHS_RUN_CLK_ENABLE"]
    #[inline(always)]
