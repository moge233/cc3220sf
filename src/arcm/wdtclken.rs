#[doc = "Reader of register WDTCLKEN"]
pub type R = crate::R<u32, super::WDTCLKEN>;
#[doc = "Writer for register WDTCLKEN"]
pub type W = crate::W<u32, super::WDTCLKEN>;
#[doc = "Register WDTCLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::WDTCLKEN {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `BAUDCLKSEL`"]
pub type BAUDCLKSEL_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `BAUDCLKSEL`"]
...
impl R {
    #[doc = "Bits 24:25 - &quot;00&quot; - Sysclk ; &quot;01&quot; - REF_CLK (38.4 MHz) ; &quot;10/11&quot; - Slow_clk"]
    #[inline(always)]
    pub fn baudclksel(&self) -> BAUDCLKSEL_R {
        BAUDCLKSEL_R::new(((self.bits >> 24) & 0x03) as u8)
    }
    #[doc = "Bit 16 - WDOG_A_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - WDOG_A_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - WDOG_A_RUN_CLK_ENABLE"]
    #[inline(always)]
