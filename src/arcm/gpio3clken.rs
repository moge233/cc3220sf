#[doc = "Reader of register GPIO3CLKEN"]
pub type R = crate::R<u32, super::GPIO3CLKEN>;
#[doc = "Writer for register GPIO3CLKEN"]
pub type W = crate::W<u32, super::GPIO3CLKEN>;
#[doc = "Register GPIO3CLKEN `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO3CLKEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 16 - GPIO_D_DSLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - GPIO_D_SLP_CLK_ENABLE"]
    #[inline(always)]
    ...
    #[doc = "Bit 0 - GPIO_D_RUN_CLK_ENABLE"]
    #[inline(always)]
